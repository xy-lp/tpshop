...
<body>
	...
	<div class="main">
		<div class="login-form fr">
			...
			<div class="form-bd">
				<form action="/index.php/Home/Member/register" method="POST">
					...
					<dl>
						<dt>验证码</dt>
						<dd><input type="text" name="code" class="text" size="10" style="width:58px;"> <img src="/index.php/Home/Member/verify" onclick=this.src="/index.php/Home/Member/verify/"+Math.random() alt="" align="absmiddle" style="position:relative;top:-2px;"/> <a href="/index.php/Home/Member/verify/"+Math.random()" style="color:#999;">看不清，换一张</a></dd>
					</dl>
					<dl>
						<dt>&nbsp;</dt>
						<dd><input type="submit" value="立即注册" class="submit"/> <input type= "checkbox" name="treaty" checked="checked"/>阅读并同意<a href="" class="forget">服务协议</a></dd>
					</dl>
				</form>
		...
		<div class="login-form-left fl">
			...
			<div class="if">
				<h2>如果您是本站用户</h2>
				<p>我已经注册过账号，立即 <a href="/index.php/Home/Member/login" class="register">登录</a> 或是 <a href="" class="findpwd">找回密码？</a></p>
			</div>
		</div>
	</div>
