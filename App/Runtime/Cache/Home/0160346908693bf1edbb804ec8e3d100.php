                            ...
                            <div id="cat_1_menu" class="cat_menu clearfix" style="">
                                <dl class="clearfix">
                                    <?php if(is_array($cat_two)): $i = 0; $__LIST__ = $cat_two;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo1): $mod = ($i % 2 );++$i; if($vo1['parent_id'] == $vo['cat_id']): ?><dt><a href="javascript:" href=""><?php echo ($vo1["cat_name"]); ?></a></dt>
                                            <dd>
                                                <?php if(is_array($cat_three)): $i = 0; $__LIST__ = $cat_three;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo2): $mod = ($i % 2 );++$i; if($vo2['parent_id'] == $vo1['cat_id']): ?><a href="/index.php/Home/Personal/goodslist/id/<?php echo ($vo2["cat_id"]); ?>"><?php echo ($vo2["cat_name"]); ?></a><?php endif; endforeach; endif; else: echo "" ;endif; ?>
		...
		<div class="shop_member_bd_right clearfix">
			...
			<div class="shop_meber_bd_good_lists clearfix">
				...
				<table>
					...
					<tbody>
<?php if(is_array($personal_data)): $i = 0; $__LIST__ = $personal_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$pdvo): $mod = ($i % 2 );++$i;?><tr><td colspan="5">
				<table class="good">
					<thead >
					<tr><th colspan="6">
						<span><strong>订单号码：</strong><?php echo ($pdvo["order_sn"]); ?></span>
					</th></tr>
					</thead>
					<tbody>
					<tr>
						<td class="dingdan_pic"><img src="/Public/Uploads/<?php echo ($pdvo["image_thumb"]); ?>" /></td>
						<td class="dingdan_title"><span><a href=""><?php echo ($pdvo["goods_name"]); ?></a></span><br /><?php echo ($pdvo['goods_attr'][0]); ?> </td>
						<td class="dingdan_danjia">￥<strong><?php echo ($pdvo["shop_price"]); ?></strong></td>
						<td class="dingdan_shuliang"><?php echo ($pdvo["goods_nums"]); ?></td>
						<td class="dingdan_zongjia">￥<strong><?php echo $pdvo['shop_price']*$pdvo['goods_nums']?></strong><br />(免运费)</td>
						<td class="digndan_caozuo"><a href=""><?php if($pdvo['pay_status']==0): ?>等待付款<?php else: ?>已付款<?php endif; ?></a></td>
					</tr>
					</tbody>
				</table>
