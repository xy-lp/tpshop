                ...
                <ul class="shop_hd_menu_all_category_hd_menu clearfix">
                    ...
                    <?php if(is_array($cat_one)): $i = 0; $__LIST__ = $cat_one;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li id="cat_1" class="">
                            ...
                            <div id="cat_1_menu" class="cat_menu clearfix" style="">
                                <dl class="clearfix">
                                    <?php if(is_array($cat_two)): $i = 0; $__LIST__ = $cat_two;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo1): $mod = ($i % 2 );++$i; if($vo1['parent_id'] == $vo['cat_id']): ?><dt><a href="javascript:"><?php echo ($vo1["cat_name"]); ?></a></dt>
                                            <dd>
            ...
            <div class="shop_bd_top clearfix">
                    ...
                    <div class="xifan_sub_box">
                      ...
                      <div id="xifan_bd1lfimg">
                        <div>
                          <dl class=""></dl>
                          <dl class="">
                            <dt><a href="http://www.zztuku.com" title="" target="_blank"><img src="/Public/Home/images/e2dfe57add8fff66ed0964b1effd39b9.jpg" alt="2011城市主题公园亲子游"></a></dt>
                            <dd><h2><a href="http://www.zztuku.com" target="_blank">2011城市主题公园亲子游</a></h2></dd>
                          </dl>
                          <dl class="">
                            <dt><a href="http://www.zztuku.com" title="" target="_blank"><img src="/Public/Home/images/e50b5d398e3b890f08e14defbc71a94d.jpg" alt="潜入城市周边清幽之地"></a></dt>
                            <dd><h2><a href="http://www.zztuku.com" target="_blank">潜入城市周边清幽之地</a></h2></dd>
                          </dl>
                          <dl class="">
                            <dt><a href="http://www.zztuku.com" title="" target="_blank"><img src="/Public/Home/images/196b173f15685a2019ab3396cd1851a4.jpg" alt="盘点中国最美雪山"></a></dt>
                            <dd><h2><a href="http://www.zztuku.com" target="_blank">盘点中国最美雪山</a></h2></dd>
                          </dl>
                          <dl class="">
                            <dt><a href="http://www.zztuku.com" title="" target="_blank"><img src="/Public/Home/images/e81345cbc3d8a7e11f9a0e09df68221d.jpg" alt="2011西安世园会攻略"></a></dt>
                            <dd><h2><a href="http://www.zztuku.com" target="_blank">2011西安世园会攻略</a></h2></dd>
                          </dl>
                          <dl class="">
                            <dt><a href="http://www.zztuku.com" title="" target="_blank"><img src="/Public/Home/images/65662b58848da87812ba371c7ff6c1ad.jpg" alt="五月乐享懒人天堂塞班岛"></a></dt>
                ...
                <div class="shop_bd_top_right clearfix">
                    <div class="shop_bd_top_right_quickLink">
                        <a href="/index.php/Home/Member/login" class="login" title="会员登录"><i></i>会员登录</a>
                        <a href="/index.php/Home/Member/register" class="register" title="免费注册"><i></i>免费注册</a>
                ...
                <div class="shop_bd_tuijian">
                    ...
                    <div class="tuijian_content">
                        <div id="tuijian_content_1" class="tuijian_shangpin" style="display: block;">
                            <ul>
		<?php if(is_array($best_good)): $i = 0; $__LIST__ = $best_good;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$bvo): $mod = ($i % 2 );++$i;?><li>
						<dl>
							<dt><a href="/index.php/Home/Index/good/id/<?php echo ($bvo["id"]); ?>"><img src="/Public/Uploads/<?php echo ($bvo["image_thumb"]); ?>" /></a></dt>
							<dd><a href="/index.php/Home/Index/good/id/<?php echo ($bvo["id"]); ?>"><?php echo ($bvo["goods_name"]); ?></a></dd>
							<dd> 商城价：<em><?php echo ($bvo["shop_price"]); ?></em>元</dd>
						</dl>
					</li><?php endforeach; endif; else: echo "" ;endif; ?>
                        ...
                        <div id="tuijian_content_2" class="tuijian_shangpin">
                            <ul>
        <?php if(is_array($hot_good)): $i = 0; $__LIST__ = $hot_good;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$hvo): $mod = ($i % 2 );++$i;?><li>
                                    <dl>
                                        <dt><a href="/index.php/Home/Index/good/id/<?php echo ($hvo["id"]); ?>"><img src="/Public/Uploads/<?php echo ($hvo["image_thumb"]); ?>" /></a></dt>
                                        <dd><a href="/index.php/Home/Index/good/id/<?php echo ($hvo["id"]); ?>"><?php echo ($bvo["goods_name"]); ?></a></dd>
                                        <dd> 商城价：<em><?php echo ($bvo["shop_price"]); ?></em>元</dd>
                                    </dl>
                                </li><?php endforeach; endif; else: echo "" ;endif; ?>
                            </ul>
                        ...
                        <div id="tuijian_content_3" class="tuijian_shangpin tuijian_content">
                            <ul>
        <?php if(is_array($new_good)): $i = 0; $__LIST__ = $new_good;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nvo): $mod = ($i % 2 );++$i;?><li>
                <dl>
                    <dt><a href="/index.php/Home/Index/good/id/<?php echo ($nvo["id"]); ?>"><img src="/Public/Uploads/<?php echo ($nvo["image_thumb"]); ?>" /></a></dt>
                    <dd><a href="/index.php/Home/Index/good/id/<?php echo ($nvo["id"]); ?>"><?php echo ($nvo["goods_name"]); ?></a></dd>
                    <dd> 商城价：<em><?php echo ($nvo["shop_price"]); ?></em>元</dd>
                </dl>
            </li><?php endforeach; endif; else: echo "" ;endif; ?>
                            </ul>
                        </div>
                ...
                <!-- 首发 -->
                <div class="shop_bd_shoufa"><img src="/Public/Home/images/shoufa.jpg" /></div>
                <!-- 首发 End -->
            ...
            <div class="shop_bd_home_block clearfix">
                ...
                <div class="shop_bd_home_block_left">
                    ...
                    <div class="shop_bd_home_block_left_pic">
                        <a href=""><img src="/Public/Home/images/web-1-13_53bfbfc958cb55a435545033bd075bf3.png"/></a>
                    </div>
                </div>
                <!-- 左边 End -->
                ...
                <div class="shop_bd_home_block_center">
                    ...
                    <div class="tabs-panel">
                        <ul>
                            <li>
                                <dl>
                                    <dt><a href=""><img src="/Public/Home/images/04fb225ea46bd1346f330400eedb7ef2.jpg_small.jpg" /></a></dt>
                ...
                <div class="shop_bd_home_block_right">
                    ...
                    <ol class="saletop-list">
                        <li class="top clearfix">
                            <dl>
                                ...
                                <dd class="nokey">1</dd>
                                <dd class="goods-pic">
                                    <a href=""><span class="thumb size60"><img src="/Public/Home/images/3f81874d594894d19150843c42fb1f8e.jpg_small.jpg" /></span></a>
                                </dd>
                    ...
                    <div class="saletop-list_adv_pic"><a href=""><img src="/Public/Home/images/web-3-38_ff9bd2d724f7138cec1b1937000f4feb.jpg" /></a></div>
                </div>
                <!-- 右边商品排行 -->
                ...
                <div class="shop_bd_home_block_bottom">
                    <ul class="">
                        <li><a href=""><img src="/Public/Home/images/354b80528d2fbeefbab33c563532517e.gif" /></a></li>
                        <li><a href=""><img src="/Public/Home/images/1d2dfbead590510046a6522551db8139.gif" /></a></li>
                        <li><a href=""><img src="/Public/Home/images/26247430b09daa1b441b46008bfb6e6e.gif" /></a></li>
                        <li><a href=""><img src="/Public/Home/images/a0ac8c6d2d3dc1470d5876923182a8e2.gif" /></a></li>
                        <li><a href=""><img src="/Public/Home/images/9c5dee77a6ecdafd9e152fed8c6a4e90.gif" /></a></li>
                        <li><a href=""><img src="/Public/Home/images/b175883eba95e793affb1b1ebbbf85a5.gif" /></a></li>
                        <li><a href=""><img src="/Public/Home/images/6e61a1c953e5bc8c5f1ffdac36862245.gif" /></a></li>
                        <li><a href=""><img src="/Public/Home/images/209abd835cd2ce2208f2dc42ba10efb4.gif" /></a></li>
                    </ul>
                </div>
                <!-- 品牌展示 End -->
