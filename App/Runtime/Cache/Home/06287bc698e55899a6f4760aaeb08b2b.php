...
<head>
	...
	<link rel="stylesheet" href="/Public/Home/css/shop_form.css" type="text/css" />
		...
		<div class="shop_member_bd_right clearfix">
			...
			<div class="shop_meber_bd_good_lists clearfix">
				...
				<dic class="shop_home_form">
					<form athion="/index.php/Home/personal/password_eidt" name="" class="shop_form" method="post">
						<ul>
							<li class="bn"><label>原密码：</label><input type="password" name="old_pwd" class="truename form-text" /></li>
							<li class="bn"><label>新密码：</label><input type="password" name="password" class="truename form-text" /></li>
							<li class="bn"><label>重复新密码：</label><input type="password" name="password1" class="truename form-text" /></li>
