...
<div id="header-div">
  ...
  <div id="submenu-div">
    ...
    <div id="send_info" style="padding: 5px 10px 0 0; clear:right;text-align: right; color: #FF9900;width:40%;float: right;">
            <a href="/index.php/Admin/Login/clearCache" target="main-frame" class="fix-submenu">清除缓存</a>
      <a href="/index.php/Admin/Login/outLogin" target="_top" class="fix-submenu">退出</a>
    </div>
...
<div id="menu-div">
  <ul>
    ...
    <li><a href="#" target="main-frame">设置导航栏</a></li>
        <li><a href="/index.php/Admin/Goods/getlist" target="main-frame">商品列表</a></li>
