...
<div class="main-div">
  <form action="/index.php/Admin/Category/add" method="post" name="theForm" enctype="multipart/form-data" onsubmit="return validate()">
...
<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo1): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo1["cat_id"]); ?>"><?php echo str_repeat('&nbsp;',$vo1['deep']*2),$vo1['cat_name']?></option><?php endforeach; endif; else: echo "" ;endif; ?>
					</select>
				</td>
			</tr>
