...
<h1>
  <span class="action-span"><a href="/index.php/Admin/Auth/add">添加管理员</a></span>
...
<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr style="background-color:#949495">
        <td class="first-cell" style="background-color: rgb(255, 255, 255);"><?php echo ($vo["auth_id"]); ?></td>
        <td align="left" style="background-color: rgb(255, 255, 255);"><?php echo str_repeat('&nbsp;',$vo['auth_level']*10),$vo['auth_name']?></td>
        <td align="center" style="background-color: rgb(255, 255, 255);"><?php echo ($vo["auth_pid"]); ?></td>
        <td align="center" style="background-color: rgb(255, 255, 255);"><?php echo ($vo["auth_c"]); ?></td>
        <td align="center" style="background-color: rgb(255, 255, 255);"><?php echo ($vo["auth_a"]); ?></td>
        <td align="center" style="background-color: rgb(255, 255, 255);"><?php echo ($vo["auth_path"]); ?></td>
        <td align="center" style="background-color: rgb(255, 255, 255);"><?php echo ($vo["auth_level"]); ?></td>
        <td align="center" style="background-color: rgb(255, 255, 255);">
          <a href="/index.php/Admin/Auth/edit/id/<?php echo ($vo["auth_id"]); ?>" title="编辑"><img src="/Public/Admin/images/icon_edit.gif" border="0" height="16" width="16"></a>&nbsp;&nbsp;
          <a href="/index.php/Admin/Auth/del/id/<?php echo ($vo["auth_id"]); ?>" onclick="listTable.remove(1, '您确认要删除这条记录吗?')" title="移除"><img src="/Public/Admin/images/icon_drop.gif" border="0" height="16" width="16"></a></td>
