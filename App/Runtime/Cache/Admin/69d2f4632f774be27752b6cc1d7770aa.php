...
<div class="main-div">
    <form action="/index.php/Admin/Grade/add" method="post" name="theForm" onsubmit="return validate()">
        <table width="100%">
            <tbody><tr>
                <td class="label">会员等级名称: </td>
                <td><input type="text" name="gd_name" value="" maxlength="20"><span class="require-field">*</span></td>
            </tr>
            <tr>
                <td class="label">积分下限: </td>
                <td><input type="text" name="min_integral" value="0" size="10" maxlength="20"></td>
            </tr>
            <tr>
                <td class="label">积分上限: </td>
                <td><input type="text" name="max_integral" value="0" size="10" maxlength="20"></td>
            </tr>
            <tr>
                <td class="label"></td>
                <td>
                    <input type="checkbox" name="is_price" value="1" checked="true"> 在商品详情页显示该会员等级的商品价格</td>
            </tr>
            <tr>
                <td class="label"></td>
                <td>
                    <input type="checkbox" name="special" value="1" onclick="javascript:doSpecial()"> 特殊会员组 <a href="javascript:showNotice('notice_special');" title="点击此处查看提示信息"><img src="/Public/Admin/images/notice.gif" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
