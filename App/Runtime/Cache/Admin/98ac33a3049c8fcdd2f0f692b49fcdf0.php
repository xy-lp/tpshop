...
<h1>
    <span class="action-span"><a href="/index.php/Admin/goods/getlist">商品回收站</a></span>
    <span class="action-span1"><a href="index.php?act=main">ECSHOP 管理中心</a> </span><span id="search_id" class="action-span1"> - 商品回收站 </span>
    <div style="clear:both"></div>
</h1>
<script type="text/javascript" src="/Public/Admin/js/utils.js"></script><script type="text/javascript" src="/Public/Admin/js/listtable.js"></script>
<!-- 商品搜索 -->
...
<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
        ...
        <td align="center">
            <a href="/index.php/Admin/Trash/restore/id/<?php echo ($vo["id"]); ?>" onclick='if(confirm('确定还原！')==false)return false;')">还原</a>  &nbsp;|&nbsp;
            <a href="/index.php/Admin/Trash/del/id/<?php echo ($vo["id"]); ?>" onclick='if(confirm('确定删除！')==false)return false;')">移除</a>
        </td>
