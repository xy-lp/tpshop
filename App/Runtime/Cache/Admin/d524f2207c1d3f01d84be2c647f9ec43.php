...
<div class="list-div" id="listDiv">
    ...
    <tr>
    <td class="first-cell" style="background-color: rgb(255, 255, 255);"><span onclick="javascript:listTable.edit(this, 'edit_type_name', 2)">音乐</span></td>
    <td style="background-color: rgb(255, 255, 255);"></td>
    <td align="right" style="background-color: rgb(255, 255, 255);">19</td>
    <td align="center" style="background-color: rgb(255, 255, 255);"><img src="/Public/admin/images/yes.gif"></td>
    ...
    <tr>
    <td class="first-cell" style="background-color: rgb(255, 255, 255);"><span onclick="javascript:listTable.edit(this, 'edit_type_name', 3)">电影</span></td>
    <td style="background-color: rgb(255, 255, 255);"></td>
    <td align="right" style="background-color: rgb(255, 255, 255);">24</td>
    <td align="center" style="background-color: rgb(255, 255, 255);"><img src="/Public/admin/images/yes.gif"></td>
    <td align="center" style="background-color: rgb(255, 255, 255);">
    ...
    <tr>
    <td class="first-cell" style="background-color: rgb(255, 255, 255);"><span onclick="javascript:listTable.edit(this, 'edit_type_name', 5)" title="点击修改内容" style="">笔记本电脑</span></td>
    <td style="background-color: rgb(255, 255, 255);"></td>
    <td align="right" style="background-color: rgb(255, 255, 255);">19</td>
    <td align="center" style="background-color: rgb(255, 255, 255);"><img src="/Public/admin/images/yes.gif"></td>
    <td align="center" style="background-color: rgb(255, 255, 255);">
    ...
    <tr>
    <td class="first-cell" style="background-color: rgb(255, 255, 255);"><span onclick="javascript:listTable.edit(this, 'edit_type_name', 6)" title="点击修改内容" style="">数码相机</span></td>
    <td style="background-color: rgb(255, 255, 255);"></td>
    <td align="right" style="background-color: rgb(255, 255, 255);">41</td>
    <td align="center" style="background-color: rgb(255, 255, 255);"><img src="/Public/admin/images/yes.gif"></td>
    <td align="center" style="background-color: rgb(255, 255, 255);">
    ...
    <tr>
    <td class="first-cell" style="background-color: rgb(255, 255, 255);"><span onclick="javascript:listTable.edit(this, 'edit_type_name', 7)" title="点击修改内容" style="">数码摄像机</span></td>
    <td style="background-color: rgb(255, 255, 255);"></td>
    <td align="right" style="background-color: rgb(255, 255, 255);">23</td>
    <td align="center" style="background-color: rgb(255, 255, 255);"><img src="/Public/admin/images/yes.gif"></td>
    <td align="center" style="background-color: rgb(255, 255, 255);">
    ...
    <tr>
    <td class="first-cell" style="background-color: rgb(255, 255, 255);"><span onclick="javascript:listTable.edit(this, 'edit_type_name', 8)">化妆品</span></td>
    <td style="background-color: rgb(255, 255, 255);"></td>
    <td align="right" style="background-color: rgb(255, 255, 255);">7</td>
    <td align="center" style="background-color: rgb(255, 255, 255);"><img src="/Public/admin/images/yes.gif"></td>
    <td align="center" style="background-color: rgb(255, 255, 255);">
    ...
    <tr>
    <td class="first-cell" style="background-color: rgb(255, 255, 255);"><span onclick="javascript:listTable.edit(this, 'edit_type_name', 9)">精品手机</span></td>
    <td style="background-color: rgb(255, 255, 255);"></td>
    <td align="right" style="background-color: rgb(255, 255, 255);">39</td>
    <td align="center" style="background-color: rgb(255, 255, 255);"><img src="/Public/admin/images/yes.gif"></td>
    <td align="center" style="background-color: rgb(255, 255, 255);">
    ...
    <tr>
    <td class="first-cell" style="background-color: rgb(255, 255, 255);"><span onclick="javascript:listTable.edit(this, 'edit_type_name', 10)">我的商品</span></td>
    <td style="background-color: rgb(255, 255, 255);"></td>
    <td align="right" style="background-color: rgb(255, 255, 255);">1</td>
    <td align="center" style="background-color: rgb(255, 255, 255);"><img src="/Public/admin/images/yes.gif"></td>
    <td align="center" style="background-color: rgb(255, 255, 255);">
      <a href="attribute.php?act=list&amp;goods_type=10" title="属性列表">属性列表</a> |
      <a href="goods_type.php?act=edit&amp;cat_id=10" title="编辑">编辑</a> |
      <a href="javascript:;" onclick="listTable.remove(10, '删除商品类型将会清除该类型下的所有属性。\n您确定要删除选定的商品类型吗？')" title="移除">移除</a>
    </td>
  </tr>
