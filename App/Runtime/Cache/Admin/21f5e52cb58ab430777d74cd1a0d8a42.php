...
<h1>
<span class="action-span"><a href="/index.php/Admin/Goodstype/getlist">商品类型列表</a></span>
<span class="action-span1"><a href="index.php?act=main">SHOP 管理中心</a> </span><span id="search_id" class="action-span1"> - 新建商品类型 </span>
<div style="clear:both"></div>
</h1>

<div class="main-div">
  <form action="/index.php/Admin/Goodstype/add" method="post" name="theForm" onsubmit="return validate();">
