...
<script type="text/javascript">
	$(function(){
		$('select[name=goods_type]').change(function(){
			var id=$(this).val();
			$.post('/index.php/Admin/Goods/showAtrr',{'id':id},function(data){
				$('#attrTable').html(data);
			});
		});
	});
...
<?php if(is_array($cat_list)): $i = 0; $__LIST__ = $cat_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cat_vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($cat_vo["cat_id"]); ?>"><?php echo str_repeat('&nbsp;',$cat_vo['deep']*2),$cat_vo['cat_name']?></option><?php endforeach; endif; else: echo "" ;endif; ?>
					</select>
                 </td>
			</tr>
			<tr>
				...
				<td>
					<select name="brand_id" onchange="hideBrandDiv()">
						<option value="0">请选择...</option>
<?php if(is_array($brand_list)): $i = 0; $__LIST__ = $brand_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$brand_vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($brand_vo["brand_id"]); ?>"><?php echo ($brand_vo["brand_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
					</select>
				</td>
			</tr>
           <!-- <tr>
          ...
          <tr>
            ...
            <td>
              <input type="file" name="goods_img" size="35">
                              <!--<a href="goods.php?act=show_image&amp;img_url=//Public/admin//images/200905/goods_img/32_G_1242110760868.jpg" target="_blank"><img src="//Public/admin//images/yes.gif" border="0"></a>
         ...
         <!-- <tr id="auto_thumb_1">
            ...
            <td id="auto_thumb_3">
              <input type="file" name="goods_thumb" size="35" disabled="">
                              <a href="goods.php?act=show_image&amp;img_url=/Public/admin///Public/admin//images/200905/thumb_img/32_thumb_G_1242110760196.jpg" target="_blank"><img src="/Public/admin///Public/admin//images/yes.gif" border="0"></a>
        ...
        <table width="90%" id="detail-table" style="display: none;">
          <tbody><tr>
            <td><input type="hidden" id="goods_desc" name="goods_desc" value="" style="display:none"><input type="hidden" id="goods_desc___Config" value="" style="display:none"><iframe id="goods_desc___Frame" src="/Public/admin/fckeditor/editor/fckeditor.html?InstanceName=goods_desc&amp;Toolbar=Normal" width="100%" height="320" frameborder="0" scrolling="no" style="margin: 0px; padding: 0px; border: 0px; background-color: transparent; background-image: none; width: 100%; height: 320px;"></iframe></td>
          </tr>
        </tbody></table>
        ...
        <table width="90%" id="mix-table" style="display: none;" align="center">
            ...
            <td><input type="text" name="goods_weight" value="" size="20"> <select name="weight_unit"><option value="1">千克</option><option value="0.001" selected="">克</option></select></td>
                              ...
                              <tr>
            <td class="label"><a href="javascript:showNotice('noticeStorage');" title="点击此处查看提示信息"><img src="/Public/admin//images/notice.gif" width="16" height="16" border="0" alt="点击此处查看提示信息"></a> 商品库存数量：</td>
<!--            <td><input type="text" name="goods_number" value="4" size="20" readonly="readonly" /><br />-->
          ...
          <tr>
            <td class="label">
            <a href="javascript:showNotice('noticeSellerNote');" title="点击此处查看提示信息"><img src="/Public/admin//images/notice.gif" width="16" height="16" border="0" alt="点击此处查看提示信息"></a> 商家备注： </td>
...
<?php if(is_array($type_list)): $i = 0; $__LIST__ = $type_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$type_vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($type_vo["id"]); ?>"><?php echo ($type_vo["type_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
						</select><br>
        ...
        <table width="90%" id="gallery-table" style="display: none;" align="center">
          <tbody><tr>
            <td>
                ...
                <img src="/Public/admin/images/200905/thumb_img/32_thumb_P_1242110760997.jpg" width="100" height="100" border="0">
                </a><br>
          ...
          <tr>
            <td>
              ...
              图片描述 <input type="text" name="album_desc[]" size="20">
