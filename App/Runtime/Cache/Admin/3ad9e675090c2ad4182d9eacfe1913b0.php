    ...
    <form name="theForm" method="post" enctype="multipart/form-data" onsubmit="return validate();">
        <table width="100%">
            <tbody><tr>
                ...
                <td>
                    <input type="text" name="user_name" maxlength="20" value="<?php echo ($list["user_name"]); ?>" size="34"><span class="require-field">*</span></td>
            </tr>
            <tr>
                <td class="label">Email地址</td>
                <td>
                    <input type="text" name="email" value="<?php echo ($list["email"]); ?>" size="34"><span class="require-field">*</span></td>
            </tr>
            <tr>
                <td class="label">
                    <a href="javascript:showNotice('passwordNotic');" title="点击此处查看提示信息">
                        <img src="/Public/Admin/images/notice.gif" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>旧密码</td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <select name="role_id">
                        <?php if(is_array($info)): foreach($info as $key=>$vo): ?><option value="<?php echo ($vo["id"]); ?>" <?php if($vo['id'] == $list['user_id']): ?>selected="selected"<?php endif; ?>><?php echo ($vo["role_name"]); ?></option><?php endforeach; endif; ?>
                    </select>
                </td>
            </tr>
            <tr>
                <td colspan="2" align="center">
                    ...
                    <input type="hidden" name="user_id" value="<?php echo ($list["user_id"]); ?>"></td>
            </tr>
            </tbody></table>
    </form>
</div>
...
<div id="footer">
    共执行 3 个查询，用时 0.011001 秒，Gzip 已禁用，内存占用 2.154 MB<br>
