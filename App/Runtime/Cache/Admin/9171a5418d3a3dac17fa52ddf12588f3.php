...
<ul>
  <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="explode" key="02_cat_and_goods" name="menu"><?php echo ($vo["priv_name"]); ?>
      <ul>
        <?php if(is_array($child)): $i = 0; $__LIST__ = $child;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo1): $mod = ($i % 2 );++$i; if($vo1['parent_pid'] == $vo[id]): ?><li class="menu-item"><a href="/index.php/Admin/<?php echo ($vo1["controller_name"]); ?>/<?php echo ($vo1["action_name"]); ?>" target="main-frame"><?php echo ($vo1["priv_name"]); ?></a></li><?php endif; endforeach; endif; else: echo "" ;endif; ?>
      </ul>
