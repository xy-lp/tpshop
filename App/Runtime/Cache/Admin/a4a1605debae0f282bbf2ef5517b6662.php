...
<form method="post" action="/index.php/Admin/Login/doLogin" name='theForm'>
  ...
  <tr>
    ...
    <td style="padding-left: 50px">
      ...
      <tr>
        <td>验证码：</td>
        <td><input type="text" name="captcha" class="capital" style="text-transform:uppercase;"  /></td>
      </tr>
      <tr>
      <td colspan="2" align="right"><img src="/index.php/Admin/Login/verify" width="145" height="20" alt="CAPTCHA" border="1" onclick= this.src="/index.php/Admin/Login/verify/"+Math.random() style="cursor: pointer;" title="看不清？点击更换另一个验证码。" />
      </td>
      </tr>
